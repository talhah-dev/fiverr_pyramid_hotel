                        ...
                        <div data-aos="fade-left" class="xl:flex items-center gap-10 hidden">
                            <ul id="navbarLinks" class="xl:flex hidden items-center text-zinc-100 gap-10">
                                ...
                                <li><a href="/tours.html"
                                        class="hover:opacity-60 tracking-wide text-nowrap  transition-all duration-500">Tours</a>
                                </li>
                                <li><a href="/contact.html"
                                        class="hover:opacity-60 tracking-wide text-nowrap  transition-all duration-500">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div id="mobileMenu"
            ...
            <div class="p-6">
                <ul class="flex relative z-50 text-[#1D2939] flex-col gap-7">
                    ...
                    <li><a href="/tours.html"
                            class="hover:opacity-60 mobileMenuCloseBtn tracking-wide  transition-all duration-500 text-nowrap">Tours</a>
                    </li>
                    <li><a href="/contact.html"
                            class="hover:opacity-60 mobileMenuCloseBtn tracking-wide  transition-all duration-500 text-nowrap">Contact Us</a>
                    </li>
                </ul>
